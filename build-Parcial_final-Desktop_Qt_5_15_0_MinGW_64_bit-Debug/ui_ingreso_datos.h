...
public:
    ...
    void setupUi(QWidget *Ingreso_datos)
    {
        ...
        XcanonOfensivo->setMinimum(10);
        XcanonOfensivo->setMaximum(500);
        ...
        XcanonDefensivo->setMinimum(550);
        XcanonDefensivo->setMaximum(950);
        ...
        YcanonOfensivo->setMinimum(100);
        YcanonOfensivo->setMaximum(550);
        ...
        YcanonDefensivo->setMinimum(100);
